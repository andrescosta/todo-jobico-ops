...
helm push ../pkgs/todo-svc-jobico-${version}.tgz oci://reg.jobico.local/helm-charts 
helm push ../pkgs/todo-web-jobico-${version}.tgz oci://reg.jobico.local/helm-charts
